...
export function SkillFormModal({ open, onClose, onSaved, initial }: SkillFormModalProps) {
  ...
  return (
    <div role="dialog" aria-modal="true" aria-label={isEdit ? "Edit Skill" : "Create Skill"} className="fixed inset-0 z-50 bg-black/55 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
